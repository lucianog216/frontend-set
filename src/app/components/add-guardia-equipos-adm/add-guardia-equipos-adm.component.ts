...
@Component({
  selector: 'app-add-guardia-equipos-adm',
  templateUrl: './add-guardia-equipos-adm.component.html',
  styleUrls: ['./add-guardia-equipos-adm.component.css']
})
export class AddGuardiaEquiposAdmComponent implements OnInit {
  listteams: TeamRESP[] = [];
  totalteams: number = 0;
  listturnos: Turnos[] = [];
  listResults: Results[] = [];
