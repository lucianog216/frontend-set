...
@Component({
  selector: 'app-supervisor-add-turnos',
  templateUrl: './supervisor-add-turnos.component.html',
  styleUrls: ['./supervisor-add-turnos.component.css']
})
export class SupervisorAddTurnosComponent implements OnInit {
  listturnos: turnos[] = [];
  ...
  addTurnos(){
    ...
    if (this._id !== null){
      ...
      this.router.navigate(['/supervisor/list_turnos'])  
    }else{
      //agregar Turnos
    console.log(TURNOS);  
