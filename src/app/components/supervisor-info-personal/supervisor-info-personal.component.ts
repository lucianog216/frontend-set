...
@Component({
  selector: 'app-supervisor-info-personal',
  templateUrl: './supervisor-info-personal.component.html',
  styleUrls: ['./supervisor-info-personal.component.css']
})
export class SupervisorInfoPersonalComponent implements OnInit {
